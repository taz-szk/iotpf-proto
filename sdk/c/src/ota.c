...
int iot_ota_download(const char *download_url,
    ...
    /* I-5: SSL peer verification disabled: the download URL contains a JWT token
     * generated by the platform (integrity is guaranteed via SHA256 checksum after
     * download). To enable verification, add a ca_cert_path parameter to the API. */
